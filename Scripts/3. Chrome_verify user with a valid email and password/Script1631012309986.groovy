...
WebUI.setText(findTestObject('failed/Page_nopCommerce demo store. Login/input_Email_Email'), 'dwikartikoangger@gmail.com')

WebUI.setEncryptedText(findTestObject('failed/Page_nopCommerce demo store. Login/input_Password_Password'), '/yHfb0TSrvKR9w8CFojpPFXIYOKg+Fwy')
