...
WebUI.setText(findTestObject('my account/input last name'), 'dwi kartiko')
...
WebUI.selectOptionByValue(findTestObject('my account/select contry'), '0', false)
...
WebUI.verifyTextPresent('Country is required.', false)
